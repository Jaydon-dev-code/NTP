...
namespace SL.MLineDataPrecisionTracking.Client.ViewModel.Control
{
    public partial class Factory6Workshop6_1AssemblyLineViewModel : ObservableObject
    {
        ...
        async Task SaveQueryAsync()
        {
            ...
            List<Factory6Workshop6_1AssemblyLineDto> re = new List<Factory6Workshop6_1AssemblyLineDto>();
            if (QueryConditions?.IsScanCode == true)
            {
            ...
            else
            {
                ...
                var apiResult = await _api.SaveQuery(request);
                ...
                re = apiResult.Data.List.Select(x => new Factory6Workshop6_1AssemblyLineDto(x)).ToList();
            }
            ...
            var ex = Expand.ExportToExcel<Factory6Workshop6_1AssemblyLineDto>(re, saveFileDialog.FileName);
            if (ex.IsSuccess)
            {
