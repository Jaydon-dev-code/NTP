...
{
    [ViewLinkServerInfoAttribute(serverNames: new[] { "Factory6Workshop6_1AssemblyLineA", "Factory6Workshop6_1AssemblyLineB" }, header: "6-1装配线数据查询", icon: "Resources\\Image\\ProductionRecord.png", MatchMode = ViewMatchMode.Any)]
