...
namespace SL.MLineDataPrecisionTracking.Core.Services.DataCollection.Factory6Workshop6_1
{
    ...
    {
        public Factory6Workshop6_1AssemblyLineB(Tb_EquipmentRepository equipmentRepositor, McpCommunication mcp, Tb_ModelNoToNameRepository tb_ModelNoToNameRepository) : base(equipmentRepositor, mcp, tb_ModelNoToNameRepository)
        {
        }
